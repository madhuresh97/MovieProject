...
namespace WiproMoviePart3
{
    ...
    class MovieTicketing
    {
        ...
        public void AgentMenu()
        {
            ...
            string Director = "Alejandro González Iñárritu";
            string Producer = "Warner Brothers";
            string Cast = "Leonardo DiCaprio, Tom Hardy, Will poulter";
            double Duration = 120;
            string Story = "A movie about the 'civility' of the 'civilized' people and the 'uncivilized' Native Americans";
            string Type = "Running";
